...
import 'package:city_pickers/src/full_page/custom_appbar.dart';
...
class FullPage extends StatefulWidget {
  ...
  final Map<String, dynamic> myCustomDesign;

  FullPage(
      {this.locationCode, this.showType, this.provincesData, this.citiesData, this.myCustomDesign});
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: widget.myCustomDesign == null ? AppBar(
...
class ListWidget extends StatelessWidget {
  ...
  final Map myCustomDesign;

  ListWidget({this.itemList, this.onSelect, this.controller, this.selectedId, this.myCustomDesign});
